 ...
 */
@Entity
@NamedQueries({ @NamedQuery(name = "InspectionDetailVw.findAll", query = "SELECT i FROM InspectionDetailVw i"),
...
public class InspectionDetailVw implements Serializable {
	...
	private String asBuiltStatusId;
	...
	public String getAsBuiltStatusId() {
		return this.asBuiltStatusId;
	}

	public void setAsBuiltStatusId(String asBuiltStatusId) {

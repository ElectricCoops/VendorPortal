...
/**
 * The persistent class for the VendorRateGrpVW database table.
 * 
 */
@Entity
@NamedQueries({
...
@SqlResultSetMapping(name = "RateGroupPivotMapping", classes = @ConstructorResult(targetClass = RateGroupPivot.class, columns = {

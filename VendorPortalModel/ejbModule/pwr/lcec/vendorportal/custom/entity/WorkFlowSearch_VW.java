...
public class WorkFlowSearch_VW implements Serializable {
	...
	private String overallAsBuiltStatusId;
	...
	public String getOverallAsBuiltStatusId() {
		return this.overallAsBuiltStatusId;
	}

	public void setOverallAsBuiltStatusId(String overallAsBuiltStatusId) {
	...
	public Integer getOverallInspectionStatusId() {
		return overallInspectionStatusId;
	}
	...
	public String getOverallInspectionStatus() {
		return overallInspectionStatus;
	}

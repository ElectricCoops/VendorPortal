...
public class AGStakingSheet implements Serializable {
	...
	private int AGStakingSheetID;

	@Column(name="AsBuiltAppealed")
	private int asBuiltAppealed;

	@Column(name="AsBuiltCompleted30Days")
	private int asBuiltCompleted30Days;

	@Column(name="AsBuiltCorrected")
	private int asBuiltCorrected;

	@Column(name="AsbuiltInProgress")
	private int asbuiltInProgress;

	@Column(name="AsBuiltNotStarted")
	private int asBuiltNotStarted;

	@Column(name="AsBuiltRejected")
	private int asBuiltRejected;
	...
	private int WOCompleted30Days;

	public AGStakingSheet() {
	}

	public int getAGStakingSheetID() {
		return this.AGStakingSheetID;
	}

	public void setAGStakingSheetID(int AGStakingSheetID) {
		this.AGStakingSheetID = AGStakingSheetID;
	}

	public int getAsBuiltAppealed() {
		return this.asBuiltAppealed;
	}

	public void setAsBuiltAppealed(int asBuiltAppealed) {
		this.asBuiltAppealed = asBuiltAppealed;
	}

	public int getAsBuiltCompleted30Days() {
		return this.asBuiltCompleted30Days;
	}

	public void setAsBuiltCompleted30Days(int asBuiltCompleted30Days) {
		this.asBuiltCompleted30Days = asBuiltCompleted30Days;
	}

	public int getAsBuiltCorrected() {
		return this.asBuiltCorrected;
	}

	public void setAsBuiltCorrected(int asBuiltCorrected) {
		this.asBuiltCorrected = asBuiltCorrected;
	}

	public int getAsbuiltInProgress() {
		return this.asbuiltInProgress;
	}

	public void setAsbuiltInProgress(int asbuiltInProgress) {
		this.asbuiltInProgress = asbuiltInProgress;
	}

	public int getAsBuiltNotStarted() {
		return this.asBuiltNotStarted;
	}

	public void setAsBuiltNotStarted(int asBuiltNotStarted) {
		this.asBuiltNotStarted = asBuiltNotStarted;
	}

	public int getAsBuiltRejected() {
		return this.asBuiltRejected;
	}

	public void setAsBuiltRejected(int asBuiltRejected) {
	...
	public int getWOCompleted30Days() {
		return this.WOCompleted30Days;
	}

	public void setWOCompleted30Days(int WOCompleted30Days) {

...
@Entity
@NamedQueries({ 
	@NamedQuery(name = "AlertNotification.findAllActive", query = "SELECT a FROM AlertNotification a"),
	@NamedQuery(name = "AlertNotification.findAll", query = "SELECT a FROM AlertNotification a"),
	@NamedQuery(name = "AlertNotification.findAlertById", query = "SELECT a FROM AlertNotification a WHERE a.alertNotificationId = :alertNotificationId"),

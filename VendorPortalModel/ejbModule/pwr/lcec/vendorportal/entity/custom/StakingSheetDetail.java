...
@NamedQueries({ @NamedQuery(name = "StakingSheetDetail.findAll", query = "SELECT s FROM StakingSheetDetail s"),
	...
	@NamedQuery(name = "StakingSheetDetail.findBySSDId", query = "SELECT s FROM StakingSheetDetail s WHERE s.stakingSheetDetailId = :stakingSheetDetailId"),
...
@NamedStoredProcedureQueries({
	@NamedStoredProcedureQuery(name = "MergeInspectionDetail", procedureName = "MergeInspectionDetail", parameters = {
			...
			@StoredProcedureParameter(mode = ParameterMode.IN, type = java.sql.Date.class, name = "InInspectionDetailDt"),
...
public class StakingSheetDetail implements Serializable {
	...
	public BigDecimal getAssemblyAmount() {
		if (assemblyAmount == null) {
			assemblyAmount = BigDecimal.ZERO;
		}
	...
	public BigDecimal getAsBuiltAmount() {
		if (asBuiltAmount == null) {
			asBuiltAmount = BigDecimal.ZERO;
		}

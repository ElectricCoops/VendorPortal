...
@Entity
@NamedQueries({
	@NamedQuery(name = "Voucher.findAll", query = "SELECT v FROM Voucher v WHERE v.workOrderId = :woId ORDER BY v.createdDt DESC"),
	...
	@NamedQuery(name = "Voucher.findById", query = "SELECT v FROM Voucher v WHERE v.voucherId = :voucherId")
})

...
public class WorkFlowSession implements WorkFlowLocal {
	...
	@SuppressWarnings("unchecked")
	@Override
	public WorkFlow findWorkflowByWfId(int wfId, String workgroup) {
	    ...
	    if (workgroup.equals("LCEC")) {
	      query = this.em.createNamedQuery("WorkFlow.findWorkflowByWfId");
	      query.setParameter("wfId", wfId);
	      query.setHint("javax.persistence.cache.storeMode", "REFRESH");
	    } else {
	      query = this.em.createNamedQuery("WorkFlow.findWorkflowByWfIdWorkGroup");
	      query.setParameter("wfId", wfId);
	      query.setParameter("workgroup", workgroup);
	      query.setHint("javax.persistence.cache.storeMode", "REFRESH");
	    } 
